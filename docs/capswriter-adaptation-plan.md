...
- 已完成 per-app 输入 profile 底座：内置常见聊天、浏览器、文档和 IDE 应用，先用于粘贴延迟和日志标注，不自动 Enter。
...
- 已完成设置分组底座：设置拆成语音、模型、智能、快捷键、数据；模型页可直接编辑 ASR 模型路径，方便主体/模型分离和移动硬盘测试。
...
| A18 | `src/main.ts` | 设置拆为语音、模型、词表、输入、翻译、数据 | 已拆成语音、模型、智能、快捷键、数据五组 |
