...
- Hardened confirm-paste focus recovery with Windows input-thread attachment, Alt foreground unlock, temporary topmost raise, and foreground retries for topmost or foreground-stealing apps.
...
- Refocused packaged Notepad input acceptance immediately before paste to reduce false failures when another foreground app steals focus between clearing and pasting.
